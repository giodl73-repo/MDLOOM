...
```mdloom:chart kind=line width=60 height=8 title="Accuracy delta across models" label-field=model value-field=delta source=md://src/user-scenarios/data/models.md#:table:0
```
