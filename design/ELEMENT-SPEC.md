...
- **F73** (row two-pass): `mdloom:row` uses a two-pass render: pass 1 collects all cell values and computes max visual_width per column; pass 2 renders each row with pinned column widths (R-1 invariant).
