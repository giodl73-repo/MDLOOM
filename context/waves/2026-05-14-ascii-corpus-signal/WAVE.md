...
Reduce remaining MAXIM ASCII warning noise where mdloom is clearly over-reading
...
| 04 - Corpus and validation gate | DONE | MAXIM remains `0` errors; full mdloom validation passes. |
